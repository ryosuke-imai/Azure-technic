...
- 驚異の手段
  - フィッシング
  - スピアフィッシング : 標的を定めたフィッシング、標的型攻撃メールなど [参考](https://cybersecurity-jp.com/column/36462)
  - 技術サポート詐欺
  - SQL インジェクション
  - パスワード盗難
  - 銀行情報盗難を目的にしたマルウェア
...
- 何か
  - マルウェアの一種
    - マルウェアとは、悪意のあるアプリやデバイスの通常の使用を妨害するコード
    - コードにより攻撃者がシステムリソースを使用したりロックを解除したりできる
  - ファイルやフォルダを暗号化して重要なファイルへのアクセスを回避するもの
- 目的
  - マルウェアの配布するサイバー犯罪者の同期は金銭
  - コンピュータへの攻撃、銀行の資格情報を取得、販売可能な情報収集して金銭を要求する

### 妨害型攻撃

ユーザが正当な使用が出来なくなるようにする攻撃

分散型 (DDos) 攻撃、インターネット経由で到達可能なエンドポイントに実行可能
